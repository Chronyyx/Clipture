...
const api: CliptureApi = {
  ...
  deleteClips: (ids) => ipcRenderer.invoke("library:delete", ids),
  importVideoFolders: () => ipcRenderer.invoke("library:importVideoFolders"),
  clipUrl: (filePath: string) => ipcRenderer.invoke("library:clipUrl", filePath),
  clipIconUrl: (clip, preferredLabels) => ipcRenderer.invoke("library:clipIconUrl", clip, preferredLabels),
  processIconUrl: (processName, executablePath) => ipcRenderer.invoke("processes:iconUrl", processName, executablePath),
  ...
  releasePlaybackCache: () => ipcRenderer.invoke("library:releasePlaybackCache"),
