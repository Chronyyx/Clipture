...
struct Diagnostics {
    ...
    int64_t recentInputMapP95_100ns = 0;
    int64_t recentNvencCallP50_100ns = 0;
    int64_t recentNvencCallP95_100ns = 0;
    int64_t recentOutputEventWaitP50_100ns = 0;
    int64_t recentOutputEventWaitP95_100ns = 0;
    int64_t recentOutputLockP95_100ns = 0;
    int64_t recentOutputCopyP95_100ns = 0;
    int64_t recentOutputUnmapP95_100ns = 0;
    uint64_t nvencZeroCopyFrames = 0;
    uint64_t nvencCopyFallbackFrames = 0;
    uint64_t nvencConvertedFrames = 0;
