...
std::string toJson(const Diagnostics& diagnostics) {
    ...
    out << "{"
        ...
        << "\"captureAcquiredUpdates\":" << diagnostics.captureAcquiredUpdates << ","
        << "\"captureDesktopPresents\":" << diagnostics.captureDesktopPresents << ","
        << "\"capturePointerUpdates\":" << diagnostics.capturePointerUpdates << ","
        << "\"capturePublishedFrames\":" << diagnostics.capturePublishedFrames << ","
        << "\"captureAccumulatedFrames\":" << diagnostics.captureAccumulatedFrames << ","
        << "\"captureAccumulationEvents\":" << diagnostics.captureAccumulationEvents << ","
        ...
        << "\"presentLatchWaits\":" << diagnostics.presentLatchWaits << ","
        << "\"presentLatchHits\":" << diagnostics.presentLatchHits << ","
        << "\"presentLatchTimeouts\":" << diagnostics.presentLatchTimeouts << ","
        << "\"catchUpEvents\":" << diagnostics.catchUpEvents << ","
        << "\"historicalFramesRecovered\":" << diagnostics.historicalFramesRecovered << ","
        << "\"catchUpRepeatedTicks\":" << diagnostics.catchUpRepeatedTicks << ","
        ...
        << "\"encodedMotionRepeatRatioPercent\":" << diagnostics.encodedMotionRepeatRatioPercent << ","
        << "\"recentMotionRepeatRatioPercent\":" << diagnostics.recentMotionRepeatRatioPercent << ","
        << "\"motionFramesTotal\":" << diagnostics.motionFramesTotal << ","
        << "\"motionFramesRepeated\":" << diagnostics.motionFramesRepeated << ","
        ...
        << "\"captureOverflowDrops\":" << diagnostics.captureOverflowDrops << ","
        << "\"captureCoalescedDrops\":" << diagnostics.captureCoalescedDrops << ","
        << "\"frameQueueMaxDepth\":" << diagnostics.frameQueueMaxDepth << ","
        << "\"sourceFramesSuperseded\":" << diagnostics.sourceFramesSuperseded << ","
        << "\"captureSlotDrops\":" << diagnostics.captureSlotDrops << ","
        << "\"captureCallbackErrors\":" << diagnostics.captureCallbackErrors << ","
        ...
        << "\"encoderAdmissionRejections\":" << diagnostics.encoderAdmissionRejections << ","
        ...
        << "\"averageScaleLatency100ns\":" << diagnostics.averageScaleLatency100ns << ","
        << "\"maximumScaleLatency100ns\":" << diagnostics.maximumScaleLatency100ns << ","
        << "\"averageInputMapLatency100ns\":" << diagnostics.averageInputMapLatency100ns << ","
        << "\"maximumInputMapLatency100ns\":" << diagnostics.maximumInputMapLatency100ns << ","
        << "\"averageNvencCallLatency100ns\":" << diagnostics.averageNvencCallLatency100ns << ","
        << "\"maximumNvencCallLatency100ns\":" << diagnostics.maximumNvencCallLatency100ns << ","
        ...
        << "\"recentInputMapP95_100ns\":" << diagnostics.recentInputMapP95_100ns << ","
        << "\"recentNvencCallP50_100ns\":" << diagnostics.recentNvencCallP50_100ns << ","
        << "\"recentNvencCallP95_100ns\":" << diagnostics.recentNvencCallP95_100ns << ","
        << "\"recentOutputEventWaitP50_100ns\":" << diagnostics.recentOutputEventWaitP50_100ns << ","
        << "\"recentOutputEventWaitP95_100ns\":" << diagnostics.recentOutputEventWaitP95_100ns << ","
        ...
        << "\"capturePressure\":\"" << jsonEscape(diagnostics.capturePressure) << "\","
        ...
        << "\"videoReplayArchiveHealthy\":" << (diagnostics.videoReplayArchiveHealthy ? "true" : "false") << ","
        << "\"audioReplayArchiveHealthy\":" << (diagnostics.audioReplayArchiveHealthy ? "true" : "false") << ","
        << "\"replayArchiveDiskBytes\":" << diagnostics.replayArchiveDiskBytes << ","
        << "\"replayArchiveRamFallbackBytes\":" << diagnostics.replayArchiveRamFallbackBytes << ","
        << "\"replayArchiveResidentBytes\":" << diagnostics.replayArchiveResidentBytes << ","
        << "\"replayArchiveResidentBudgetBytes\":" << diagnostics.replayArchiveResidentBudgetBytes << ","
        << "\"replayArchiveReadCacheBytes\":" << diagnostics.replayArchiveReadCacheBytes << ","
        << "\"replayArchiveResidentPackets\":" << diagnostics.replayArchiveResidentPackets << ","
        << "\"replayArchiveDiskBackedPackets\":" << diagnostics.replayArchiveDiskBackedPackets << ","
        << "\"replayArchiveQueuedBytes\":" << diagnostics.replayArchiveQueuedBytes << ","
        << "\"replayArchivePersistedPackets\":" << diagnostics.replayArchivePersistedPackets << ","
        << "\"replayArchiveSpillCandidateInspections\":" << diagnostics.replayArchiveSpillCandidateInspections << ","
        ...
        << "\"replayArchiveSegments\":" << diagnostics.replayArchiveSegments << ","
        << "\"replayArchiveMaximumWriteBytes\":" << diagnostics.replayArchiveMaximumWriteBytes << ","
        << "\"pcmRecoveryActive\":" << (diagnostics.pcmRecoveryActive ? "true" : "false") << ","
